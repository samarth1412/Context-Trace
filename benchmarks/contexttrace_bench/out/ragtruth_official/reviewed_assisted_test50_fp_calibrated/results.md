...
| --- | ---: |
| `cases` | 50 |
| `failure_label_exact_match_rate` | 0.36 |
| `failure_label_macro_f1` | 0.181 |
| `claim_verdict_macro_f1` | 0.124 |
...
| --- | ---: | ---: | ---: |
| `failure_label_macro_f1` | 0.181 | 0.119 to 0.248 | 100 |
| `claim_verdict_macro_f1` | 0.124 | 0.082 to 0.161 | 100 |
| `root_cause_accuracy` | 0.4 | 0.28 to 0.54 | 100 |
| `citation_error_f1` | 1.0 | 1.0 to 1.0 | 100 |
| `evidence_span_overlap` | 0.883 | 0.815 to 0.951 | 100 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `contradicted_answer` | 0.238 | 0.556 | 0.333 | 5 | 16 | 4 |
| `insufficient_context` | 0.0 | 1.0 | 0.0 | 0 | 6 | 0 |
| `no_failure_detected` | 1.0 | 0.314 | 0.478 | 11 | 0 | 24 |
| `partial_support` | 0.174 | 0.667 | 0.276 | 4 | 19 | 2 |
| `should_have_abstained` | 0.0 | 1.0 | 0.0 | 0 | 5 | 0 |
| `unsupported_answer` | 0.0 | 1.0 | 0.0 | 0 | 6 | 0 |

## SOTA Readiness Gates

| Metric | Gate | Value | Status |
| --- | ---: | ---: | --- |
| `failure_label_macro_f1` | `>= 0.95` | 0.181 | fail |
| `claim_verdict_macro_f1` | `>= 0.95` | 0.124 | fail |
| `root_cause_accuracy` | `>= 0.9` | 0.4 | fail |
| `citation_error_f1` | `>= 0.9` | 1.0 | pass |
| `evidence_span_overlap` | `>= 0.75` | 0.883 | pass |
...
| `ragtruth_27` | `no_failure_detected` | `no_failure_detected` | `no_failure_detected -> no_failure_detected` |
...
| `ragtruth_45` | `no_failure_detected` | `no_failure_detected` | `no_failure_detected -> no_failure_detected` |
| `ragtruth_46` | `contradicted_answer` | `contradicted_answer` | `conflicting_contexts -> conflicting_contexts` |
| `ragtruth_47` | `no_failure_detected` | `no_failure_detected` | `no_failure_detected -> no_failure_detected` |
| `ragtruth_54` | `no_failure_detected` | `contradicted_answer, partial_support` | `no_failure_detected -> conflicting_contexts` |
| `ragtruth_55` | `no_failure_detected` | `contradicted_answer` | `no_failure_detected -> conflicting_contexts` |
| `ragtruth_56` | `no_failure_detected` | `contradicted_answer, insufficient_context, unsupported_answer` | `no_failure_detected -> insufficient_context` |
...
| `ragtruth_66` | `no_failure_detected` | `contradicted_answer, partial_support` | `no_failure_detected -> conflicting_contexts` |
| `ragtruth_67` | `no_failure_detected` | `partial_support` | `no_failure_detected -> answer_overreach` |
| `ragtruth_68` | `partial_support` | `partial_support` | `answer_overreach -> answer_overreach` |
...
| `ragtruth_70` | `no_failure_detected` | `contradicted_answer` | `no_failure_detected -> conflicting_contexts` |
...
| `ragtruth_125` | `no_failure_detected` | `contradicted_answer` | `no_failure_detected -> conflicting_contexts` |
| `ragtruth_138` | `no_failure_detected` | `contradicted_answer` | `no_failure_detected -> conflicting_contexts` |
| `ragtruth_139` | `no_failure_detected` | `contradicted_answer` | `no_failure_detected -> conflicting_contexts` |
...
| `ragtruth_185` | `partial_support` | `partial_support` | `answer_overreach -> answer_overreach` |
| `ragtruth_204` | `no_failure_detected` | `partial_support` | `no_failure_detected -> answer_overreach` |
