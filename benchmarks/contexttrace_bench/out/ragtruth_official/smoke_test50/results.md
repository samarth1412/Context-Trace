...
- Case source: RAGTruth case pack adapted for ContextTrace external validation. These cases are scaffolding until answer-side hallucination spans are human-mapped to source-side evidence spans. from benchmarks/contexttrace_bench/out/ragtruth_official/ragtruth_case_pack_test50.json
...
| --- | ---: |
| `cases` | 50 |
| `failure_label_exact_match_rate` | 0.26 |
| `failure_label_macro_f1` | 0.15 |
| `claim_verdict_macro_f1` | 0.122 |
...
| --- | ---: | ---: | ---: |
| `failure_label_macro_f1` | 0.15 | 0.074 to 0.202 | 100 |
| `claim_verdict_macro_f1` | 0.122 | 0.077 to 0.155 | 100 |
| `root_cause_accuracy` | 0.28 | 0.14 to 0.4 | 100 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `contradicted_answer` | 0.222 | 0.444 | 0.296 | 4 | 14 | 5 |
| `insufficient_context` | 0.0 | 1.0 | 0.0 | 0 | 6 | 0 |
| `no_failure_detected` | 1.0 | 0.229 | 0.373 | 8 | 0 | 27 |
| `partial_support` | 0.138 | 0.667 | 0.229 | 4 | 25 | 2 |
| `should_have_abstained` | 0.0 | 1.0 | 0.0 | 0 | 7 | 0 |
| `unsupported_answer` | 0.0 | 1.0 | 0.0 | 0 | 8 | 0 |
...
| `claim_verdict_macro_f1` | `>= 0.95` | 0.122 | fail |
| `root_cause_accuracy` | `>= 0.9` | 0.28 | fail |
| `citation_error_f1` | `>= 0.9` | 1.0 | pass |
| `evidence_span_overlap` | `>= 0.75` | 0.0 | fail |
...
| `ragtruth_54` | `no_failure_detected` | `contradicted_answer` | `no_failure_detected -> conflicting_contexts` |
...
| `ragtruth_69` | `no_failure_detected` | `contradicted_answer, insufficient_context, partial_support, should_have_abstained, unsupported_answer` | `no_failure_detected -> answer_overreach` |
| `ragtruth_70` | `no_failure_detected` | `partial_support` | `no_failure_detected -> answer_overreach` |
...
| `ragtruth_140` | `no_failure_detected` | `partial_support` | `no_failure_detected -> answer_overreach` |
...
| `ragtruth_148` | `no_failure_detected` | `contradicted_answer, unsupported_answer` | `no_failure_detected -> retrieval_miss` |
