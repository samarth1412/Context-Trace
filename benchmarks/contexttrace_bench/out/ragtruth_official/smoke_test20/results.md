...
- Case source: RAGTruth case pack adapted for ContextTrace external validation. These cases are scaffolding until answer-side hallucination spans are human-mapped to source-side evidence spans. from benchmarks/contexttrace_bench/out/ragtruth_official/ragtruth_case_pack_test20.json
...
| --- | ---: |
| `cases` | 20 |
| `failure_label_exact_match_rate` | 0.25 |
| `failure_label_macro_f1` | 0.144 |
...
| `root_cause_reported_cases` | 20 |
| `citation_status_reported_cases` | 20 |
| `evidence_span_reported_cases` | 0 |
| `latency_p50_ms` | 225.316 |
| `latency_p95_ms` | 518.777 |
...
| --- | ---: | ---: | ---: |
| `failure_label_macro_f1` | 0.144 | 0.066 to 0.318 | 50 |
| `claim_verdict_macro_f1` | 0.134 | 0.082 to 0.195 | 50 |
| `root_cause_accuracy` | 0.25 | 0.1 to 0.45 | 50 |
| `citation_error_f1` | 1.0 | 1.0 to 1.0 | 50 |
| `dangerous_false_green_rate` | 0.0 | 0.0 to 0.0 | 50 |

## Failure Label Breakdown

| Label | Precision | Recall | F1 | TP | FP | FN |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `contradicted_answer` | 0.286 | 0.5 | 0.364 | 2 | 5 | 2 |
| `insufficient_context` | 0.0 | 1.0 | 0.0 | 0 | 3 | 0 |
| `no_failure_detected` | 1.0 | 0.2 | 0.333 | 3 | 0 | 12 |
| `partial_support` | 0.091 | 1.0 | 0.167 | 1 | 10 | 0 |
| `should_have_abstained` | 0.0 | 1.0 | 0.0 | 0 | 3 | 0 |
| `unsupported_answer` | 0.0 | 1.0 | 0.0 | 0 | 3 | 0 |

## SOTA Readiness Gates

| Metric | Gate | Value | Status |
| --- | ---: | ---: | --- |
| `failure_label_macro_f1` | `>= 0.95` | 0.144 | fail |
| `claim_verdict_macro_f1` | `>= 0.95` | 0.134 | fail |
| `root_cause_accuracy` | `>= 0.9` | 0.25 | fail |
