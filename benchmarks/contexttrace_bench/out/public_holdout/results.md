...
| `latency_p50_ms` | 6.185 |
| `latency_p95_ms` | 11.463 |
...
| --- | ---: | ---: | ---: |
| `failure_label_macro_f1` | 1.0 | 1.0 to 1.0 | 400 |
| `claim_verdict_macro_f1` | 1.0 | 1.0 to 1.0 | 400 |
| `root_cause_accuracy` | 1.0 | 1.0 to 1.0 | 400 |
| `citation_error_f1` | 1.0 | 1.0 to 1.0 | 400 |
| `evidence_span_overlap` | 0.95 | 0.936 to 0.966 | 400 |
