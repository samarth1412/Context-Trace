...
NO_FAILURE = FailureType.NO_FAILURE_DETECTED.value
...
class ReliabilityScorer:
    """Practical diagnostic score for RAG reliability reports.

    This is intentionally simple and explainable. It combines available metrics,
    skips unavailable optional metrics, and keeps raw metrics visible separately.
    """
    ...
    def score_trace(
        ...
        *,
        ...
        failure_type: str,
        chunks: Optional[list[Mapping[str, Any]]] = None,
        ...
        return self.score(
            ...
            retrieval_quality=_retrieval_quality(chunks or []),
            abstention_quality=_abstention_quality(failure_type),
            token_efficiency=_token_efficiency(usage or {}),
        )
...
def _abstention_quality(failure_type: str) -> Optional[float]:
    if failure_type == FailureType.SHOULD_HAVE_ABSTAINED.value:
        return 0.0
    return None
